...
A log stack to visulaize NetFlows that are processed and collected by Elastiflow in Grafana. Uses Kafka as a data ingester and VictoriaLogs as a log storage backend.
